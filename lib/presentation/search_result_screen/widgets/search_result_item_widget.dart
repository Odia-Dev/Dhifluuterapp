...
class SearchResultItemWidget extends GetView<SearchResultItemController> {
  @override
              ...
              children: [
                Column(
                  ...
                  children: [
                    Text(
                      controller
                          .searchResultItemWidgetUiModelObj.msgNikeAirMax27!,
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          controller.searchResultItemWidgetUiModelObj.lbl29943!,
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                controller
                                    .searchResultItemWidgetUiModelObj.lbl53433!,
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: Text(
                                  controller.searchResultItemWidgetUiModelObj
                                      .lbl24Off!,
                                  overflow: TextOverflow.ellipsis,
                                  textAlign: TextAlign.left,
                                  style:
                                      AppStyle.textStylePoppinsbold10.copyWith(
                                    fontSize: getSize(
                                      10,
                                    ),
                                  ),

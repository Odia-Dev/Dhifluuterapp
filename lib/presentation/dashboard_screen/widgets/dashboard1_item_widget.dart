...
class Dashboard1ItemWidget extends GetView<Dashboard1ItemController> {
  @override
  Widget build(BuildContext context) {
    return Container(
        ...
        child: GestureDetector(
            ...
            child: Container(
                margin: EdgeInsets.only(right: getSize(16)),
                    ...
                    children: [
                      ...
                      Padding(
                          padding: EdgeInsets.only(
                              ...
                              right: getSize(16)),
                          child: Text(
                              controller.dashboard1ItemWidgetUiModelObj
                                  .msgFsNikeAirM!,
                      ...
                      Padding(
                          ...
                          child: Text(
                              controller
                                  .dashboard1ItemWidgetUiModelObj.lbl29943!,
                          ...
                          child: Row(
                              ...
                              children: [
                                Expanded(
                                    child: Text(
                                        controller
                                            .dashboard1ItemWidgetUiModelObj
                                            .lbl53433!,

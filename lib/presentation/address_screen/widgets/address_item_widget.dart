...
class AddressItemWidget extends GetView<AddressItemController> {
  @override
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text(
              controller.addressItemWidgetUiModelObj.lblPriscekila!,
          ...
          Padding(
            ...
            child: Text(
              controller.addressItemWidgetUiModelObj.msg3711SpringHil!,
          ...
          Padding(
            ...
            child: Text(
              controller.addressItemWidgetUiModelObj.lbl991234567890!,
              style: AppStyle.textStylePoppinsregular12.copyWith(
                fontSize: getSize(
                  12,
                ),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Expanded(
                  child: Text(
                    controller.addressItemWidgetUiModelObj.lblEdit!,
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Text(
                      controller.addressItemWidgetUiModelObj.lblDelete!,
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.left,
